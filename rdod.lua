...
return bot.sendText(msg_chat_id,msg_id,'تع هنا يحب  @CAESAHOS',"md",true)  
end
if text == '..' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
if text == 'قيصر' or text == 'مين قيصر' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
...
if text == 'مصنع' or text == 'المصنع' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return bot.sendText(msg_chat_id,msg_id,'*قلبي المصنع اهو 💕 @C_a_s_e_r_bot*',"md",true)  
end
if text == '👍🏿' or text == '👍🏿👍🏿' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
...
if text == 'محمد' or text == 'ابن القيصر' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return bot.sendText(msg_chat_id,msg_id,'*ابن قيصر دي متحكش بقا☺️*',"md",true)  
end
...
if text == 'لولا' or text == 'لولا' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return bot.sendText(msg_chat_id,msg_id,'*حبيبه قيصر دي خدبالك💕*',"md",true)  
end
...
if text == 'سي في قيصر' or text == 'cv قيصر' then
if not Redis:get(Fast.."rb:bna"..msg_chat_id) then
return bot.sendText(msg_chat_id,msg_id,"* *","md",true)  
end
return bot.sendText(msg_chat_id,msg_id,'*لاسم : حسام: السن :19 سنه: من المنيا *',"md",true)  
end
...
data = {
{
{text = 'قناه السورس', url = 't.me/H_8HC'}, 
},
}
}
...
data = {
{
{text = '◜𝐒𝐎𝐔𝐑𝐂𝐄 𝐂𝐀𝐄𝐒𝐀𝐑◞', url = 't.me/H_8HC'}, 
},
}
}
