...
if text == 'قيصر' or text == 'مطور السورس' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = '- 𝘀 𓆩™𓆪 𝗮𝗹𝗰𝗮𝗲𝘀𝗮𝗿 🕷️ ​​​​​​​​​​​​​​​​​​⤸ٰ', url = 't.me/c_a_s_e_r_h'}, 
},
}
}
return send(msg_chat_id,msg_id,'*صاحب السورس ده ينجم*',"md",false, false, false, false, reply_markup)
end
...
return send(msg_chat_id,msg_id,'*الاسم قيصر-السن-20-المحافظه-المنيا-الرتبه-مبرمج السورس*',"md",false, false, false, false, reply_markup)
end
