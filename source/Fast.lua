...
chsource = Redis:get(Fast..'chsource') or "rb_ro"
devsource = Redis:get(Fast..'devsource') or "r_n_b1"
devmaghola = Redis:get(Fast..'devmaghola') or ""
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5912085775,5969871722,5598844635,0000000000000}
...
if UserId == 5912085775 then
Status = true
elseif UserId == 5969871722 then
Status = true
elseif UserId == 5598844635 then
Status = true
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5912085775) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5912085775) then
...
if text == 'فوفا' or text == 'فراولا' or text == 'كل حياة الفينوم' then  
local UserId_Info = bot.searchPublicChat("F2rawla20")
...
local TestText = "  ❲ 𓂄✭𓆩𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈✭𓂁 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯ ˹𝘿𝙚𝙫˼MOSCOW◞', url = "https://t.me/U_u_63"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄✭𓆩𝙑𝙀𝙉𝙊𝙈𓂁 ❳', url = "https://t.me/r_n_b1"}
},
{
{text = '❲ ⁨𓂄✭𓆩𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈𓂁 ❳', url = "https://t.me/rb_ro"},
},
}
local msg_id = msg.id/2097152/0.5 
...
if text == 'موسكو' or text == ' موسكوتي' or text == 'موسكو حجي' then  
local UserId_Info = bot.searchPublicChat("U_u_63")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ժᎥꪔ᥆ꪀժ ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ꪔY υ᥉ᥱᖇ', url = "https://t.me/U_u_63"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '❲  𓆩𝙑𝙀𝙉𝙊𝙈𓂁 ❳', url = "https://t.me/r_n_b1"}
},
{
{text = '❲ ⁨ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈❳', url = "https://t.me/rb_ro"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local UserId_Info = bot.searchPublicChat("z_h_r_f_a_bot")
if UserId_Info.id then
...
if text == 'مطور السورس' or text == 'فينوم ' then  
local UserId_Info = bot.searchPublicChat("r_n_b1")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local UserId_Info = bot.searchPublicChat("merat_caser")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
if text == 'فينوم' or text == 'فينوم' then  
local UserId_Info = bot.searchPublicChat("r_n_b1")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈◞˼⁩ ,❳\nᥫ᭡\n ✭ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n✭  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑  𝙑𝙀𝙉𝙊𝙈  .', url = 't.me/r_n_b1'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'زوز ' or text == ' زوزتي' then  
local Get_Chat = bot.getChat(msg_chat_id)
local Info_Chats = bot.getSupergroupFullInfo(msg_chat_id)
...
bot.sendText(5912085775,0,'*\n✭  مرحباً عزيزي فينوم \nشخص ما يحتاج الي مساعده\n⩹━━━━ََِِ⁨◜ 𓂄✭𓆩𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈✭𓂁◞˼⁩ ,━━━━⩺ \n✭  اسمه ↫ '..klajq..' \n✭  ايديه ↫  : '..msg.sender_id.user_id..'\n✭  - معرفة '..basgk..' \n*',"md",false, false, false, false, reply_markup)
end
if text == 'مصنع' or text == 'صانع' or text == 'المصنع' then   
photo = "https://telegra.ph/file/86d498dc56eb3dbb376c7.jpg"
local T =[[
— — — — — — — — —— — — 
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5183920797) then
...
data = {
{
{text = '◜ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈', url = 'http://t.me/'..chsource..''}, 
},
{
{text = '◜ 𝙈𝙮  𝙑𝙀𝙉𝙊𝙈◞', url = 't.me/'..devsource}, 
},
{
{text = '◜ 𝙈𝙮 MOSCOW', url = 't.me/U_u_63'}, 
},
{
  {text = '◜ 𝙈𝙮 ZOZ◞', url = 't.me/ZzzzOoooozZ'}, 
  },
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
╔══════════"𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒂𝒆𝒔𝒂𝒓"═══════════╗
║                             𝒘𝒆𝒍𝒄𝒐𝒎𝒆 𝒕𝒐 𝒔𝒐𝒖𝒓𝒄𝒆 𝒄𝒂𝒆𝒔𝒂𝒓                               
║                   𝁂 𝙈𝘼𝙆𝙀𝙍     :[𝙈𝘼𝙆𝙀𝙍  𝙑𝙀𝙉𝙊𝙈⋮](https://t.me/B72_bot) 𝁂     
╚══════════════════════════════╝
...
"انا مش فاضي الكل موجود مكاني اهو", 
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n⚡️ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "فينوم")..
'\n🤖⋮ اختصاص البوت حماية المجموعات'..
'\n💻⋮ لتفعيل البوت عليك اتباع مايلي ...'..
'\n🚀⋮ اضف البوت الى مجموعتك'..
'\n🤴🏽⋮ ارفعه ادمن مشرف'..
'\n🕹⋮ ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n🔮⋮ ارسل كلمة { /caser} لاظهار الكيبورد'..
'\n💥⋮ مطور البوت -›«@'..UserSudo..'»*'
...
if text == '/caser' or text == 'عوده' or text == 'رجـوع ✭' then  
Redis:sadd(Fast..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "الفينوم")..
...
data = {
{
{text = '« فينوم»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ✭ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "فينوم")..
...
if text == 'مبرمج السورس ✭' or text == 'مبرمج السورس' or text == 'فينوم' then  
local UserId_Info = bot.searchPublicChat("r_n_b1")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈 ❳\nᥫ᭡\n ✭︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n✭︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑  𝙑𝙀𝙉𝙊𝙈 ❳', url = "https://t.me/rb_ro"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج فينوم ', url = "https://t.me/r_n_b1"}
},
{
{text = '◜ 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈', url = "https://t.me/rb_ro"},
},
...
photo = "https://telegra.ph/file/df9f53d8899292ea04e63.jpg"
local T =[[
