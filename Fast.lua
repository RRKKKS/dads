...
send(msg.chat_id,msg.id,"✭ اهلا بك في صانع بوتات سورس فينوم \n✭ مطور البوت @r_n_b1","html",true, false, false, true, reply_markup)
return false 
end
if text == '. السورس' or text == '✭ مبرمج السورس' or text == 'مطور السورس ✭' then  
local UserId_Info = LuaTele.searchPublicChat("r_n_b1")
...
photo = "https://t.me/RB_RO"
local T =[[
☆︙[𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝑆𝑂𝑈𝑅𝐶𝐸 𝙑𝙀𝙉𝙊𝙈](t.me/RB_RO )
]]
keyboard = {} 
...
{
    {text = '• زوز•', url = 't.me/ZzzzOoooozZ '},
    },
    {
        {text = '• موسكو•', url = 't.me/U_u_63 '},
        },
{
{text = '• تنصيب بوت مدفوع •', url = 't.me/r_n_b1'},
},
{
{text = '• قناة التحديثات •', url = 't.me/rb_ro '},
},
{  
{text = '• 𝙎𝙊𝙐𝙍𝘾𝙀 𝙑𝙀𝙉𝙊𝙈 •', url = 't.me/rb_ro '},
},
}
